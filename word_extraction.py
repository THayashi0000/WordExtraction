...
for row in range(sheet_1.nrows):
    ...
    for token in tokens:
        ...
        #or partOfSpeech == u'動詞' or partOfSpeech == u'形容詞' or partOfSpeech == u'助動詞':
            each_data.append(token.base_form) # token.surfaceは表層形(語彙)です。詳しくはこちら...http://ailaby.com/janome/
...
# 例）C:\Users\〜\Documents\〜
# パスの前のrは省略しないでください
data_book = xlsxwriter.Workbook(input_file[:-4] + ".edit.xlsx")
# シート作成・変数定義
...
result_book = xlsxwriter.Workbook(input_file[:-4] + ".ranked.xlsx")
